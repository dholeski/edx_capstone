...
Start analysis, beginning with the mean rating only. Then create the RMSE comparison table that will ultimately be used to decide on the best model.
```{r message=FALSE}
...
RMSE table outlining the analyzed models and their respective RMSE results. The graph shows a visual representation of how the RMSE was changed with the different models.
